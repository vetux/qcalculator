...
class BitButton(QtWidgets.QPushButton):
    def __init__(self, parent):
        ...
        self.setMaximumSize(QtCore.QSize(15, 30))
        self.setStyleSheet(
...
class BitViewWidget(QtWidgets.QWidget):
    def __init__(self, parent):
        ...
        bitgroup_16.setMargin(10)
        bitgroup_15.setMargin(10)
        bitgroup_14.setMargin(10)
        bitgroup_13.setMargin(10)
        bitgroup_12.setMargin(10)
        bitgroup_11.setMargin(10)
        bitgroup_10.setMargin(10)
        bitgroup_9.setMargin(10)
        bitgroup_8.setMargin(10)
        bitgroup_7.setMargin(10)
        bitgroup_6.setMargin(10)
        bitgroup_5.setMargin(10)
        bitgroup_4.setMargin(10)
        bitgroup_3.setMargin(10)
        bitgroup_2.setMargin(10)
        bitgroup_1.setMargin(10)
